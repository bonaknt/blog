...
class UserDAO extends DAO implements UserProviderInterface
{
     ...
     *
     * @param \AlaskaBlog\Domain\User $user The user to save
     */
     ...
     *
     * @return \AlaskaBlog\Domain\User|throws an exception if no matching user is found
     */
    ...
    {
        return 'AlaskaBlog\Domain\User' === $class;
    }
